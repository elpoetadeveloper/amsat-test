echo proceso para subir pasoshtm.xx y paseshtm.xx a lu7aa.org.ar
echo bajada de kepleriano y corrida del itpass para nuevos archivos
cd c:\it
echo Se suben archivos de Pasos a www.amsat.org.ar
cd c:\it
ftp -s:ftptotal.txt
cd c:\it
...
copy nasa.all d:\webs\amsat.org.ar\text\nasa.all
